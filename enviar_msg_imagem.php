                            ...
                            <form class="form-horizontal" action="" method="post" id="formCadastro" enctype="multipart/form-data" name="cadastrar">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn" type="submit" id="inputGroupFileAddon04" name="submit">Carregar & Enviar</button>
                                        <a href="painel.php" button class="btn" type="submit"  name="submit">Início</button></a>
                                    </div>
                                </div>
                        </div>
                    </div>
